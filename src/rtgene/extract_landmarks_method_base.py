...
from rtgene.download_tools import download_external_landmark_models

# noinspection PyUnresolvedReferences
import rtgene.gaze_tools as gaze_tools
from rtgene.SFD.sfd_detector import SFDDetector
from rtgene.ThreeDDFA.ddfa import ToTensorGjz, NormalizeGjz
from rtgene.ThreeDDFA.inference import crop_img, predict_68pts, parse_roi_box_from_bbox, parse_roi_box_from_landmark
from rtgene.tracker_generic import TrackedSubject
...
class LandmarkMethodBase(object):
    ...
    def load_face_landmark_model(self, checkpoint_fp=None):
        import rtgene.ThreeDDFA.mobilenet_v1 as mobilenet_v1
